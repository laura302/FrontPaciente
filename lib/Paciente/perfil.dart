      ...
      child: Center(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              const Text("Paciente", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
              ...
              Container(
                ...
                child: const Text("Usuario: Paciente1", style: TextStyle(fontSize: 14)),
              ),
